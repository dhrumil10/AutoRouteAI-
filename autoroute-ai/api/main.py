...
#     routes_data = routing_agent.compute_routes(
#         origin_coord, destination_coord, priority=request.priority, alternatives=request.alternatives
#     )

#     # For now, generate explanation only for first route; extend as needed
#     explanation = assistant_agent.generate_explanation(
#         route=[request.origin, request.destination],
#         traffic_data={},
#         energy_estimate=0,      # Extend to estimate energy per route if desired
#         energy_unit="",
#         vehicle_type=request.vehicle_type,
#     ) + f"\n\nNumber of route alternatives: {len(routes_data)}"
